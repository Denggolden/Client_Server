...
void FileManageWin::FileReceiveWinHandle(QString sendUserID, QString targetUserID, int curFileTransferBindID, int fileByteArrSize)
{
...
void FileManageWin::FileSendWinHandle(QString sendUserID, QString targetUserID, int curFileTransferBindID, int fileByteArrSize)
{
    FileSendWinListMutex.lock();
...
void FileManageWin::HandelOperateSolts(TransferDataModel &transferDataModel)
{
    ...
    if(commandType==ReceiveFileReady){
